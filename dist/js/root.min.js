function main(){var e=document.getElementById("dots2"),t=document.getElementById("more2"),l=document.getElementById("myBtn2");"none"===e.style.display?(e.style.display="inline",t.style.display="none"):(e.style.display="none",l.innerHTML="Буцаах",t.style.display="inline")}function seeMore(e){let t=e.parentElement.querySelector("p");e.classList.contains("active")?(e.classList.remove("active"),t.style.maxHeight="260px"):(e.classList.add("active"),t.style.maxHeight=e.parentElement.querySelector("p").scrollHeight+"px")}function seeMore1(e){let t=e.parentElement.querySelector("div");e.classList.contains("active")?(e.classList.remove("active"),t.style.maxHeight="350px"):(e.classList.add("active"),t.style.maxHeight=e.parentElement.querySelector("div").scrollHeight+"px")}console.log();
