function main(){var e=document.getElementById("dots2"),n=document.getElementById("more2"),t=document.getElementById("myBtn2");"none"===e.style.display?(e.style.display="inline",n.style.display="none"):(e.style.display="none",t.innerHTML="Буцаах",n.style.display="inline")}
